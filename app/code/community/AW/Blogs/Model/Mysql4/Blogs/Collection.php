...
class AW_Blogs_Model_Mysql4_Blogs_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function joinComments()
    {
        ...
        $select
            ->from(
                Mage::getSingleton('core/resource')->getTableName('blogs/comment'),
