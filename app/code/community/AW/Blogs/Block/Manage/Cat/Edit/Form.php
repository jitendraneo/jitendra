...
class AW_Blogs_Block_Manage_Cat_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'category_form', array('legend' => Mage::helper('blogs')->__('Category Information'))
        );
        ...
        $fieldset->addField(
            ...
            'text',
            array(
                 'label' => Mage::helper('blogs')->__('Sort Order'),
                 'name'  => 'sort_order',
            )
        );
