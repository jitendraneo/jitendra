...
class AW_Blogs_Block_Cat extends AW_Blogs_Block_Blogs
{
    ...
    {
        return Mage::getSingleton('blogs/cat');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if ($breadcrumbs) {
            ...
            $breadcrumbs->addCrumb('blogs_page', array('label' => $post->getTitle(), 'title' => $post->getTitle()));
        }
