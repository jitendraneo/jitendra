...
class AW_Blogs_Block_Product_Toolbar extends AW_Blogs_Block_Product_ToolbarCommon
{
    ...
    public function getCurrentDirection()
    {
        ...
        return strtolower(Mage::helper('blogs')->defaultPostSort(Mage::app()->getStore()->getId()));
    }
