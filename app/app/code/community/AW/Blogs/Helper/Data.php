...
class AW_Blogs_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_ENABLED = 'blogs/blogs/enabled';
    const XML_PATH_FOOTER_ENABLED = 'blogs/blogs/footerEnabled';
    const XML_CRUMBS_ENABLED = 'blogs/blogs/blogscrumbs';
    const XML_COMMENTS_PER_PAGE = 'blogs/comments/page_count';
    const XML_COMMENTS_ENABLED = 'blogs/comments/enabled';
    const XML_POSTS_PER_PAGE = 'blogs/blogs/perpage';
    const XML_BOOKMARKS = 'blogs/blogs/bookmarkslist';
    const XML_PATH_BOOKMARKS_POST = 'blogs/blogs/bookmarkspost';
    const XML_ROOT = 'blogs/blogs/route';
    const XML_CATEGORIES_URL = 'blogs/blogs/categories_urls';
    ...
    const XML_PATH_DATE_FORMAT = 'blogs/blogs/dateformat';
    const XML_DEFAULT_POST_SORT = "blogs/blogs/sorter";

    /* menus and links */
    const XML_PATH_LAYOUT = 'blogs/blogs/layout';
    const XML_RECENT_SIZE = 'blogs/menu/recent';
    /* metadata */
    const XML_PATH_TITLE = 'blogs/blogs/title';
    const XML_PATH_KEYWORDS = 'blogs/blogs/keywords';
    const XML_PATH_DESCRIPTION = 'blogs/blogs/description';
    const DEFAULT_PAGE_COUNT = 10;
    const DEFAULT_ROOT = 'blogs';
    ...
    {
        return $this->conf(self::XML_BLOGS_USESHORTCONTENT, $store);
    }

    public function readMoreCount($store = null)
    {
        return $this->conf(self::XML_BLOGS_READMORE, $store);
    }
    ...
    {
        return Mage::getStoreConfig('blogs/blogs/enabled') && $this->extensionEnabled('AW_Blogs');
    }
    ...
    {
        return (Mage::getStoreConfigFlag('blogs/rss/enable') && Mage::getStoreConfigFlag('rss/config/active'));
    }
    ...
    public function isTagAvailable($tag)
    {
        ...
        $allStoreTags = Mage::getModel('blogs/tag')->getCollection()
