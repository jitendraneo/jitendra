...
class AW_Blogs_Model_Dateformat
{
    ...
    public function toOptionArray()
    {
        if (!$this->_options) {
            $this->_options[] = array(
                ...
                'label' => Mage::helper('blogs')->__('Full')
            );
            $this->_options[] = array(
                'value' => self::FORMAT_TYPE_LONG,
                'label' => Mage::helper('blogs')->__('Long')
            );
            $this->_options[] = array(
                'value' => self::FORMAT_TYPE_MEDIUM,
                'label' => Mage::helper('blogs')->__('Medium')
            );
            $this->_options[] = array(
                'value' => self::FORMAT_TYPE_SHORT,
                'label' => Mage::helper('blogs')->__('Short')
            );
        }
