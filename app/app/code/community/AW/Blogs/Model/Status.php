...
class AW_Blogs_Model_Status extends Varien_Object
{
    ...
    {
        return array(
            self::STATUS_ENABLED  => Mage::helper('blogs')->__('Enabled'),
            self::STATUS_DISABLED => Mage::helper('blogs')->__('Disabled'),
            self::STATUS_HIDDEN   => Mage::helper('blogs')->__('Hidden')
        );
    }
}