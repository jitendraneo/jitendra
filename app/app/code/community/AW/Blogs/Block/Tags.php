...
class AW_Blogs_Block_Tags extends Mage_Core_Block_Template
{
    protected function _construct()
    {
        parent::_construct();
        return $this->setTemplate('aw_blogs/tags.phtml');
    }
    ...
    public function getCollection()
    {
        if (!$this->getData('collection')) {
            ...
            $collection = Mage::getModel('blogs/tag')->getCollection()->getActiveTags();
