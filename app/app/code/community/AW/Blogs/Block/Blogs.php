...
class AW_Blogs_Block_Blogs extends AW_Blogs_Block_Abstract
{
    ...
    {
        if ($this->isBlogsPage() && ($breadcrumbs = $this->getCrumbs())) {
            ...
            if ($tag) {
                ...
                $breadcrumbs->addCrumb('blogs', array('label' => self::$_helper->getTitle()));
            }
        }
    }
    ...
    public function getCurrentDirection()
    {
        ...
        return Mage::helper('blogs')->defaultPostSort(Mage::app()->getStore()->getId());
    }
